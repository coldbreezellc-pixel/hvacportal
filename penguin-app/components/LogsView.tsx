...
const ACTION_TYPES = ["All", "Login", "Logout", "Qty Changed", "Item Added", "Item Updated", "Item Deleted", "Stock Reset", "User Created", "User Updated", "User Deleted", "Password Reset", "Password Changed"];
